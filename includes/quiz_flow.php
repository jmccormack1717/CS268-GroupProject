    ...
    <div id="container">
        ...
        <div class="main">
            <div class="content admin-content">
                <h1><?= h($pageTitle) ?></h1>
                <p class="admin-nav"><a href="index.html">Home</a> &middot; <a href="categories.html">Categories</a> &middot; <a href="<?= h($leaderLink) ?>">Leaderboard</a> &middot; <a href="logout.php">Log out</a></p>
